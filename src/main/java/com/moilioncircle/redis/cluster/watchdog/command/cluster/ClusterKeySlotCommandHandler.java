...
import static com.moilioncircle.redis.cluster.watchdog.storage.StorageEngine.calcSlot;

/**
 * @author Leon Chen
 * @since 1.0.0
 */
public class ClusterKeySlotCommandHandler extends AbstractCommandHandler {

    public ClusterKeySlotCommandHandler(ClusterManagers managers) {
        super(managers);
    }
